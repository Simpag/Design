...
global.weaponArray[0,2] = 35; //Damage
...
global.weaponArray[1,2] = 25; //Damage
global.weaponArray[1,3] = 10; //Rate of fire
...
global.weaponArray[2,2] = 2; //Damage
global.weaponArray[2,3] = 100; //Rate of fire
...
global.weaponArray[2,7] = spr_watergun_bullet; //bullet sprite
...
global.weaponArray[2,15] = 150; //Clip size
...
global.weaponArray[3,1] = 100; //Ammo
global.weaponArray[3,2] = 35; //Damage
...
global.weaponArray[4,19] = 6; //Number Of Pellets
